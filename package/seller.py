...
class Seller:
    ...
    def get_review_score(self):
        ...
        reputation_dict = {1 : 100, 2: 50, 3: 40, 4: 0, 5: 0}
        df["reputation_cost"] = df["review_score"].map(reputation_dict)
    ...
    def get_training_data(self):
        ...
        training_set["revenue"] = training_set["sales"]*0.1 + training_set["months_on_olist"]*80
        training_set["profit"] = training_set["revenue"]-training_set["reputation_cost"]
